...
// span 요소의 부모 요소에 스타일 : 글자색 red, border 2px solid red
$('span').parent().css({'color' : 'red', 'border' : '2px solid red'})
// li 요소의 모든 상위 요소에 스타일 적용 글자색 blue
$('li').parents().css('color', 'blue');
// li 요소의 상위 요소 중 div만 스타일 적용 border 굵기 - 2px, 스타일 - dashed, 색상 - 토마토
$('li').parents('div').css({
    'border' : '2px dashed tomato'
})
// span 요소부터 div 요소 이전까지 상위 요소 스타일 적용 배경색 - lavenderblush
...
// .wrap인 요소의 자식의 자식 요소들에 style2을 적용
$('.wrap').children().children().css(style2);
// .wrap인 요소의 자식의 자식 요소 중 ul 태그의 style3을 적용
