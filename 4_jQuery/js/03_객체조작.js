...
// #content1의 a 태그 속성 href에 http://naver.com 대입
$('#content1 a').prop('href', 'http://naver.com');
// #content2의 a 태그 속성에도 href에 http://naver.com 대입
...
// 1) remove
// remove 버튼을 클릭 시 #item2를 remove로 제거 후 remove-result에 리턴받은 값 출력
...
// #each-test에 배열의 값들을
// a링크로 href에는 link, content 부분에는 name을 사용해서 출력!
let result = '';
$.each(array, function(index, element) {
